...
This project was built as a final assignment for the **Deep Learning** course at SGH Warsaw School of Economics. I worked through each stage (EDA, preprocessing, architecture design, hyperparameter tuning, evaluation) with explanations at every step, with the explicit goal of understanding *why* each decision was made, not just producing a working notebook. 
